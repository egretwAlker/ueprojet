...
The problems with methodes above are: 1. Not considering the order/structure of sentences
in a document; 2. having a parameter to determine which can not be optimal uniformly for
...
Here we use the persistent homology to analyse essays and grading (specifically the
