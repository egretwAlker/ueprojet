...
The problems with the methodes above are: 1. Not considering the order/structure of sentences
in a document; 2. having a parameter (k in KNN) to determine which can not be optimal uniformly for
...
Here we use the persistent homology to analyse discoursive essays and grading (specifically the
