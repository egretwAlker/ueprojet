...
when the most common words are `stopwords'.

tf-idf (term frequency - inverse document frequency) first consider
the whole of corpus, it assumes a term too frequent in a corpus has little
information. Then it considers the importance of a term in a document
as the frequency of the term in this document times a coefficient
