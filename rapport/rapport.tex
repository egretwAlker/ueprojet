...
\paragraph{Negative} \begin{itemize}
  \item Supervised
  \item No resistence to disporpotional data
...
\paragraph{On the results}

A graph with different k with or without balancing.
...
\subsection{Topological data analysis, persistent homology}
