\begin{tikzpicture}[scale=0.4]
  ...
  \draw[->] ($(v1)+(d)$) -- ++(0,-2) node[below] {$\text{Formula}_1$};
  \draw[->] ($(w1)+(d)$) -- ++(0,-2) node[below] {$\text{Formula}_2$};
  \draw[->] ($(u1)+(d)$) -- ++(0,-2) node[below] {$\text{Formula}_3$};
  \draw[->] ($(uu1)+(d)$) -- ++(0,-2) node[below] {$\text{Formula}_4$};
